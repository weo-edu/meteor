/**
 * @license AngularJS v1.1.6-e96a4a4
 ...
 */
var version = {
  full: '1.1.6-e96a4a4',    // all of these placeholder strings will be replaced by grunt's
...
function $RouteProvider(){
  var scopedRoutes = {},
    ...
    function pushRoute(scope, route) {
      var key = scopeKey(scope);
      scopedRoutes[key].routes[route.originalPath] = route;
    }
